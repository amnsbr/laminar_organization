#!/usr/bin/bash
# Wrapper for code/fetch_abagen.py to make it compatible with htcondor
...
${HOME}/laminar_gradients/laminar_gradients_env/bin/python ${HOME}/laminar_gradients/code/local/fetch_abagen.py